...
We can also plot this distribution and horizontal draw lines indicating intervals with for example, 2 standard deviations from mean (about 95% interval), to visually compare theoretical and simulation standard deviations.
